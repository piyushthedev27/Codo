      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-[#0F172A] border-r border-[#1E293B] relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-6xl font-black text-white leading-none tracking-tight mb-6">
            EVOLVE YOUR <br />
            <span className="text-[#FF5C00]">KNOWLEDGE_BASE</span>
          </h1>
          <p className="text-[#94A3B8] text-lg max-w-md border-l-2 border-[#00D1FF] pl-6 py-2">
            Connect with AI study buddies Sarah, Alex, and Jordan to master complex subjects through interactive insights.
          </p>
        </div>
      ...
      <div className="flex flex-col items-center justify-center p-6 lg:p-12 overflow-y-auto max-h-screen custom-scrollbar">
        <div className="w-full max-w-md">
          <div className="lg:hidden text-center mb-10">
            ...
            <h2 className="text-3xl font-black text-white tracking-tighter uppercase mb-2">Join Codo</h2>
            <p className="text-[#94A3B8]">Start learning with your AI buddies</p>
          </div>

          <div className="bg-[#0F172A] border border-[#1E293B] shadow-[0_0_50px_rgba(0,0,0,0.5)] p-0 rounded-none relative">
            {/* Industrial corner accents */}
            <div className="absolute -top-px -left-px w-4 h-4 border-t border-l border-[#00D1FF]"></div>
            <div className="absolute -bottom-px -right-px w-4 h-4 border-b border-r border-[#FF5C00]"></div>
            ...
            <SignUp
              appearance={{
                elements: {
                  ...
                  formButtonPrimary: 'bg-[#FF5C00] hover:bg-[#E65100] text-[#020617] font-black uppercase tracking-widest text-sm py-3 rounded-none transition-all shadow-[0_0_20px_rgba(255,92,0,0.2)] hover:shadow-[0_0_30px_rgba(255,92,0,0.4)]',
                  footerActionText: 'text-[#94A3B8]',
                  footerActionLink: 'text-[#00D1FF] hover:text-[#00B8E6] font-bold uppercase tracking-tighter transition-all',
          ...
          <div className="text-center mt-8">
            <p className="text-sm font-mono text-[#475569] uppercase tracking-widest">
              ...
              <a
                href="/sign-in"
                className="text-[#00D1FF] hover:text-[#FF5C00] font-bold transition-all border-b border-transparent hover:border-[#FF5C00] pb-0.5"
              >
                SIGN IN HERE
              </a>
            </p>
